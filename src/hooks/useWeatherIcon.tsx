...
export const useWeatherIcon = (props?: UseWeatherCodeProps) => {
    ...
    switch (weatherCode) {
      ...
      case 48:
        return {
          ...
          label: t('weather.depositingRimeFog'),
          emoji: '🌫️',
      ...
      case 71:
        return {
          name: 'slightSnowfall',
          label: t('weather.slightSnowfall'),
          emoji: '🌨️',
